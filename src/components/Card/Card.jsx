    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        <div className={styles.column}>
          ...
          <p>
            <FiCreditCard /> <strong>Payment Method:</strong> {paymentMethod}
          </p>
          <p>
            <FiTag /> <strong>Category:</strong> {category}
          </p>
        </div>
        ...
        <div className={styles.column}>
          ...
          <p>
            <FiDollarSign /> <strong>Amount:</strong> {currency}{" "}
            {amount.toFixed(2)}
          </p>
          <p>
        ...
        <div className={styles.column}>
          ...
          <p>
            <FiCalendar /> <strong>Issue Date:</strong>{" "}
            {new Date(issueDate).toLocaleDateString()}
          </p>
          <p>
            <FiCalendar /> <strong>Due Date:</strong>{" "}
            {new Date(dueDate).toLocaleDateString()}
          </p>
          <p>
            <FiCalendar /> <strong>Payment Date:</strong>{" "}
            {paymentDate
